            ...
            <div className="flex items-center gap-x-6 lg:order-2">
                <div className="flex">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <form action="">
                        <input type="text" id="search-navbar" className="block w-full p-2 ps-10 pe-10 text-sm text-gray-900 border-[2.5px] border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                        <button className='absolute inset-y-0 end-0 flex items-center pe-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" id="arrow-circle-down" viewBox="0 0 24 24" fill='currentColor' className="w-6 h-6 text-green-600"><path d="M0,12A12,12,0,1,0,12,0,12.013,12.013,0,0,0,0,12ZM14.535,6.293l3.586,3.586h0a3,3,0,0,1,0,4.243l-3.586,3.585-.025.024a1,1,0,1,1-1.389-1.438L16.414,13,6,13.007a1,1,0,1,1,0-2L16.413,11,13.121,7.707a1,1,0,1,1,1.414-1.414Z"/></svg>
                        </button>
                        </form>
                    </div>
                </div>
                ...
                <Link href="/cart" className="hover:text-white text-gray-400 bg-primary-700 hover:bg-primary-800 font-medium rounded-lg text-sm py-2 lg:py-2.5 bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-primary-800"  title="Cart">
